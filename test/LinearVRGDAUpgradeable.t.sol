...
import {MockLinearVRGDAUpgradeable} from "./mocks/MockLinearVRGDAUpgradeable.sol";

uint256 constant ONE_THOUSAND_YEARS = 356 days * 1000;

contract LinearVRGDAUpgradeableTest is DSTestPlus {
    MockLinearVRGDAUpgradeable vrgda;

    function setUp() public {
        vrgda = new MockLinearVRGDAUpgradeable();
        vrgda.initialize(
