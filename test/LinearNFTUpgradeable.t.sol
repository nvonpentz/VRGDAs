...
import {LinearNFTUpgradeable} from "../src/examples/LinearNFTUpgradeable.sol";

contract LinearNFTUpgradeableTest is DSTestPlus {
    LinearNFTUpgradeable nft;

    function setUp() public {
        nft = new LinearNFTUpgradeable();
        nft.initialize();
    }
