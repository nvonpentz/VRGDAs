...
import {MockLogisticVRGDAUpgradeable} from "./mocks/MockLogisticVRGDAUpgradeable.sol";

uint256 constant ONE_THOUSAND_YEARS = 356 days * 1000;

uint256 constant MAX_SELLABLE = 6392;

contract LogisticVRGDAUpgradeableTest is DSTestPlus {
    MockLogisticVRGDAUpgradeable vrgda;

    function setUp() public {
        vrgda = new MockLogisticVRGDAUpgradeable();
        vrgda.initialize(
