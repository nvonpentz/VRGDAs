...
import {LogisticVRGDAUpgradeable} from "../LogisticVRGDAUpgradeable.sol";

/// @title Logistic VRGDA NFT
/// @author transmissions11 <t11s@paradigm.xyz>
/// @author FrankieIsLost <frankie@paradigm.xyz>
/// @notice Example NFT sold using LogisticNFTUpgradeable.
/// @dev This is an example. Do not use in production.
contract LogisticNFTUpgradeable is ERC721Upgradeable, LogisticVRGDAUpgradeable {
    /*//////////////////////////////////////////////////////////////
                                CONSTANTS
    //////////////////////////////////////////////////////////////*/
    ...
    function initialize() external initializer {
        __ERC721_init("Example Logistic VRGDA NFT", "LOGISTIC");
        __LogisticVRGDA_init(
    ...
    function mint() external payable returns (uint256 mintedId) {
        ...
        // revert if we're over the max mintable limit we set when constructing LogisticVRGDAUpgradeable.
